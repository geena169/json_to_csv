...
# Файл переписыавется в json файл с простой струкурой (раскрыты вложенные объекты и масиивы с объектами)
# Ex:
...
# Сковзь время я понимаю, что написано это не самым лучшим образом, и что подход не самый оптимальный, т.к. обработка больших фвйлов занимает достаточно много времни,
